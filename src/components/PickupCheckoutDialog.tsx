  ...
  return (
    <div className="fixed inset-0 z-[110] bg-black/60" role="presentation">
      <form
        ...
        className="absolute top-1/2 left-1/2 flex max-h-[94dvh] w-[92vw] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-[2vw] bg-white leading-none md:w-[640px] md:rounded-2xl"
      ...
      >
        ...
        <div className="min-h-0 w-full flex-1 overflow-y-auto bg-[#f3f3f3] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          ...
          <section className="mx-[2.5vw] mt-[2.5vw] flex bg-white p-[3vw] text-[4.3vw] font-medium text-[#fdbc24] md:mx-4 md:mt-4 md:p-5 md:text-lg">
            <span className="shrink-0">{t("storeAddressLabel")}</span>
            <span className="flex-1 pl-[1vw] text-[3.7vw] leading-[5vw] font-normal text-[#333] md:pl-2 md:text-sm md:leading-5">
              {storeAddress}
            </span>
          </section>
