...
const messages = {
  vi: {
    ...
    enterAddress: "Vui lòng nhập địa chỉ nhận hàng", discountCode: "Mã giảm giá:", enterDiscountCode: "Nhập mã giảm giá (nếu có)",
  ...
  en: {
    ...
    enterAddress: "Enter the delivery address", discountCode: "Promo code:", enterDiscountCode: "Enter promo code (optional)",
  ...
  "zh-Hans": {
    ...
    enterPhone: "请输入电话号码", enterAddress: "请输入配送地址", discountCode: "优惠码：", enterDiscountCode: "请输入优惠码（如有）",
  ...
  "zh-Hant": {
    ...
    enterPhone: "請輸入電話號碼", enterAddress: "請輸入配送地址", discountCode: "優惠碼：", enterDiscountCode: "請輸入優惠碼（如有）",
