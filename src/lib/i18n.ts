...
const messages = {
  vi: {
    ...
    orderPlaced: "Đặt hàng thành công", orderPlacedDetail: "Mã đơn hàng của bạn", viewOrder: "Xem đơn hàng",
    deviceOrders: "Đơn hàng đã đặt trên thiết bị này", loadingOrders: "Đang tải đơn hàng...", refreshOrders: "Làm mới",
    orderLookupFailed: "Không thể tải trạng thái đơn hàng.", orderCode: "Mã đơn", orderStatus: "Trạng thái",
    statusPending: "Chờ xác nhận", statusConfirmed: "Đã xác nhận", statusPreparing: "Đang chuẩn bị",
    statusReady: "Sẵn sàng", statusCompleted: "Hoàn thành", statusCancelled: "Đã huỷ",
    ...
    enterAddress: "Vui lòng nhập địa chỉ nhận hàng",
    storeAddressLabel: "Địa chỉ cửa hàng:", addedNow: "Thêm lần này:",
    ...
    referralDiscount: "Giảm giá giới thiệu", referralDiscountBanner: "Ưu đãi giới thiệu: Bạn được giảm", referralCode: "Mã giới thiệu",
  },
  en: {
    ...
    orderPlaced: "Order placed", orderPlacedDetail: "Your order code", viewOrder: "View order",
    deviceOrders: "Orders placed on this device", loadingOrders: "Loading orders...", refreshOrders: "Refresh",
    orderLookupFailed: "Could not load the order status.", orderCode: "Order code", orderStatus: "Status",
    statusPending: "Pending", statusConfirmed: "Confirmed", statusPreparing: "Preparing",
    statusReady: "Ready", statusCompleted: "Completed", statusCancelled: "Cancelled",
    ...
    enterAddress: "Enter the delivery address",
    storeAddressLabel: "Store address:", addedNow: "Items:",
    ...
    referralDiscount: "Referral discount", referralDiscountBanner: "Referral offer: You get a discount of", referralCode: "Referral code",
  },
  "zh-Hans": {
    ...
    orderPlaced: "下单成功", orderPlacedDetail: "您的订单编号", viewOrder: "查看订单",
    deviceOrders: "此设备下的订单", loadingOrders: "正在加载订单...", refreshOrders: "刷新",
    orderLookupFailed: "无法加载订单状态。", orderCode: "订单编号", orderStatus: "状态",
    statusPending: "待确认", statusConfirmed: "已确认", statusPreparing: "准备中",
    statusReady: "可取货", statusCompleted: "已完成", statusCancelled: "已取消",
    ...
    enterPhone: "请输入电话号码", enterAddress: "请输入配送地址",
    storeAddressLabel: "门店地址：", addedNow: "本次商品：",
    ...
    referralDiscount: "推荐优惠", referralDiscountBanner: "推荐专享：全场立减", referralCode: "推荐码",
  },
  "zh-Hant": {
    ...
    orderPlaced: "下單成功", orderPlacedDetail: "您的訂單編號", viewOrder: "查看訂單",
    deviceOrders: "此裝置下的訂單", loadingOrders: "正在載入訂單...", refreshOrders: "重新整理",
    orderLookupFailed: "無法載入訂單狀態。", orderCode: "訂單編號", orderStatus: "狀態",
    statusPending: "待確認", statusConfirmed: "已確認", statusPreparing: "準備中",
    statusReady: "可取貨", statusCompleted: "已完成", statusCancelled: "已取消",
    ...
    enterPhone: "請輸入電話號碼", enterAddress: "請輸入配送地址",
    storeAddressLabel: "門店地址：", addedNow: "本次商品：",
    ...
    referralDiscount: "推薦優惠", referralDiscountBanner: "推薦專享：全場立減", referralCode: "推薦碼",
  },
} as const;
